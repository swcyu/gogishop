...
function copy() {
	  var obj = document.getElementById("gogishop");
...
function popup1(){
		...
		document.getElementById("popup1").className = "visable";

}
function popup2(){
		document.body.classList.add('hidden'); 
		document.getElementById("dark").className = "visable";
		document.getElementById("popup2").className = "visable";
...
function popupCancle(){
    ...
    document.getElementById("popup1").className = "unvisable";
    document.getElementById("popup2").className = "unvisable";
}
function loginCheck(){
...
function sendLinkCustom() {
    Kakao.init("8d187686d4cd9b3a5a39a6437149b74d");
...
.close{
	...
	border-radius: 50%;
	background-image: url('<%=cp%>/meat/image/close.png') ;
...
<div id="popup1" style=" width: 500px; height: 290px; position: fixed;transition: all 0.5s;left:700px;
	 top:300px; z-index: 9999; padding-top: 20px"   class="unvisable" align="center">
	<div style="width: 100%; height: 100%;position: relative;" >
		<table width="480px" height="280px" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
			<tr><td align="center" style="font-size: 20pt;font-weight: 900; padding-top: 18px;">친구 초대 URL 공유하기</td></tr>
			<tr><td align="center" ><div id="gogishop" align="center" style="font-size: 12pt;width:400px;height:60px ;
			font-weight: 700;border: 1px solid #000000; padding-top: 15px;">http://localhost:8080/study/meatShop/main.do</div></td></tr>
			<tr><td align="center"><div align="center" onclick="copy()" style="cursor: pointer; background-color: black; color: white;
			font-size: 15pt;font-weight: 700; width: 400px; height: 60px;padding-top: 15px;"  >링크 복사하기</div></td></tr>
			<tr><td align="center" style="font-size: 10pt; padding-bottom: 10px;">* 복사가 되지 않는다면 직접 드래그해서 복사해주세요.</td></tr>	
		</table>
		<div class="close" align="center" onclick="popupCancle();"></div>
	</div>
</div>
<div id="popup2" style=" width: 500px; height: 290px; position: fixed;transition: all 0.5s;left:700px;
	 top:300px; z-index: 9999; padding-top: 20px"   class="unvisable" align="center">
	<div style="width: 100%; height: 100%;position: relative;" >
		<table width="480px" height="280px" border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
			<tr><td align="center" style="font-size: 21pt;font-weight: 900; padding-top: 25px;">서비스 준비중 입니다</td></tr>
			<tr><td align="center"><div align="center" onclick="popupCancle();" style="cursor: pointer; background-color: black; color: white;
			font-size: 15pt;font-weight: 700; width: 400px; height: 60px;padding-top: 15px;"  >닫 기</div></td></tr>	
		</table>
	</div>
</div>
<!-- <div id="popup2" style=" width: 500px; height: 260px; position: fixed;transition: all 0.5s;left:700px;
	 top:300px; z-index: 9999; padding-top: 20px"   class="unvisable" align="center">
	<div style="width: 100%; height: 100%; background-color: #ffffff; border-radius: 3px"  >
		<table>
			<tr height="50px"><td width="100%" align="center" style="padding-top:40px;  font-size: 15pt; font-weight: 900;">장바구니에 무료 삼겹살이 이미 담겨있어요.</td></tr>
			<tr height="30px"><td align="center" style="font-size: 13pt;padding-top:20px;">15,000원 이상 다른 상품과 함께 구매해주세요.</td></tr>
...
<div>
<div><img alt="" src="../meat/image/main2_1.png"></div>
<div><img alt="" src="../meat/image/main2_2.png"></div>
<div><img alt="" src="../meat/image/main2_3.png"></div>

<div style="position: sticky; bottom: 0px;" ><div style="position: relative;"><img alt="" src="../meat/image/main2_4.png">
<div style="position: absolute; left: 1224px; top: 30px;" >
<a href="javascript:sendLinkCustom();"><img src="../meat/image/main2_icon1.png"></a></div>
<div style="position: absolute; left: 1299px; top: 29px;">
<a href="javascript:popup2();"><img src="../meat/image/main2_icon2.png"></a></div>
<div style="position: absolute; left: 1372px; top: 29px;">
<a href="javascript:popup1();"><img src="../meat/image/main2_icon3.png"></a></div>
</div></div>
