...
<tr style="height: 30px;"><td></td></tr>
<tr><td><img alt="" src="../meat/image/agree.png"></td></tr>
...
<tr>
	<td style="float:left; text-align: center; font-size: 15px; line-height: 24px;">
	<input type="checkbox" name="service"> 정육각 서비스 약관 동의</td>
</tr>

<tr>
<td style="margin-left: 20px; padding-right: 20px; padding-top: 20px; border: none;">
<iframe style="padding: 10px; border: 1px solid #e1dedf;" width="738px" height="200px"  src="https://yookgak.com/website/term-20191015.html"></iframe>
</td>
</tr>
</table>
...
<tr>
	<td style="float:left; text-align: center; font-size: 15px; line-height: 24px;">
	<input type="checkbox" name="pinfo"> 개인정보 이용 방침</td>
</tr>

<tr>
<td style="margin-left: 20px; padding-right: 20px; padding-top: 20px; border: none;">
<iframe style="padding: 10px; border: 1px solid #e1dedf;" width="738px" height="200px"  src="https://yookgak.com/website/private-20191015.html"></iframe>
</td>
</tr>
...
<tr style="margin: 6px;">
<td>
<input style="width: 49%; height: 60px; border: none; background-color: #888; color: #fff; 
font-size: 16px; text-align: center; float: left;" type="button"  value="이전으로"
 onclick="javascript:location.href='<%=cp%>/meatShop/createdenter.do';"/>
<input style="width: 49%; height: 60px; border: none; background-color: #000; color: #fff; 
font-size: 16px; text-align: center; float: left;" type="button"  value="동의하기" onclick="sendIt();"/>
</td>
</tr>
<tr style="height: 30px;"><td></td></tr>
