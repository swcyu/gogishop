...
<tr><td style="font-size: 24px; font-weight: 700; margin-top: 60px; text-align: center; color: #212121">로그인</td></tr>
<tr style="height: 20px;"><td></td></tr>
</table>

<table style="margin: auto;text-align: left;">
<tr style=""><td style="margin-top: 60px; font-size: 18px; font-weight: 700; width: 360px; margin-left: auto; margin-right: auto;">이메일 로그인</td></tr>
<tr style="height: 20px;"><td></td></tr>
</table>

<table style="margin: auto;text-align: center;">
<tr>
<td style="width: 312px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: none; width: 298px; height: 40px;" type="text" name="userId" placeholder="아이디(이메일 주소)를 입력하세요"/>
</td>
</tr>

<tr>
<td style="width: 312px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: none; width: 298px; height: 40px;" type="password" name="userPwd" placeholder="비밀번호를 입력하세요"/>
</td>
</tr>

<tr>
<td><input style="width: 348px; height: 48px; border: none; background-color: #000; color: #fff; 
font-size: 16px; margin-top: 8px; border-radius: 4px; text-align: center;" type="button"  value="로그인" onclick="login();"/></td>
</tr>

<tr style="height: 20px;"><td></td></tr>
<tr>
<td style="font-size: 16px; text-align: center;">
<a href="<%=cp%>/meatShop/searchpw.do">아이디 / 비밀번호 찾기</a>
</td>
</tr>
...
<tr style="text-align: left;"><td style="margin-top: 60px; font-size: 18px; font-weight: 700; width: 328px; margin-left: auto; margin-right: auto;">SNS 간편 로그인</td></tr>
...
<script type="text/javascript">
		var clientId = "1vCqf3AZHS04V5QPiz84";
		var callbackUrl = "http://www.localhost:8080/study/meatShop/main.do";
		var naver_id_login = new naver_id_login(clientId, callbackUrl);
		var state = naver_id_login.getUniqState();
		naver_id_login.setButton("green", 3, 55);
		naver_id_login.setDomain("http://www.localhost:8080/study/meatShop/login.do");
...
<tr>
<td style="font-size: 16px; text-align: center;">정육각이 처음이신가요? 

<a href="<%=cp%>/meatShop/createdenter.do"><font color="red">회원가입하기</font></a>
</td>
</tr>
