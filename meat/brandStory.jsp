...
function oneoneQ(){
	...
	document.myForm.action = "<%=cp%>/meatShop/support.do?view=question";
	document.myForm.submit();	
}
</script>
...
<div style="height: 645px; background-color: #1c1c1c;" align="center">
<img src="https://jeongyookgak.com/static/img/1.2015a78.png" style="height: 645px;">
</div>
<div align="center">

<div style="height: 200px"></div>

<img src="https://jeongyookgak.com/static/img/2.5cc7e40.png" 
style="width: 780px;">
<div style="height: 230px"></div>

<img src="<%=cp %>/meat/image/gomin.png" style="width: 1200px;">

<div align="center" style="width: 1200px; position: relative;">
<img src="https://jeongyookgak.com/static/img/4.63dfe55.png" style="width: 1200px;" align="middle">
<div style="position: relative; top:-600px;" align="center"><h5><b>그 이유는 식재료 시장에 고착화된 관행과 불편한 진실이 존재하기 때문입니다.</b></h5></div>
</div>

<img src="https://jeongyookgak.com/static/img/5.7ed8a93.png" style="width: 1200px;">
<div style="height: 300px"></div>
<img src="<%=cp %>/meat/image/isee.png" style="width: 1200px;">
...
<img src="https://jeongyookgak.com/static/img/6.97809cc.png" style="width: 590px;"></div>
</td>
<td style="width: 50%; padding-left: 120px;">
<img src="https://jeongyookgak.com/static/img/7.d5d055d.png" style="width: 480px;">
</td>
</tr>
</table>
</div>
<img src="<%=cp %>/meat/image/vision.png" style="width: 1200px;">
<div style="height: 110px"></div>
<img src="https://jeongyookgak.com/static/img/8.ef8ef88.png" style="width: 1200px;">

<div style="height: 600px"></div>
<h5>나아가 여러분의 일상 속에 '고기샵을 먹는 습관'이 스며들기를 바랍니다.</h5>
<div style="height: 600px"></div>

<table style="width: 1200px;">
	<tr>
		<td style="width: 50%"> <img src="https://jeongyookgak.com/static/img/9.384035c.gif" style="width: 600px;">
		</td>
		<td style="width: 50%">
		<div style="width: 320px; font-size: 40pt; color: black;">
		<b>고기샵을<br>먹는 습관의<br>첫걸음</b>
		<div style="width: 280px; height: 70px; background-color: black; margin-top: 60px;">
		<div style="font-size: 12pt; color: white; padding-left: 30px; padding-top: 5px; padding-right: 30px; cursor: pointer;" 
		onclick="location.href='<%=cp%>/meatShop/list.do'">
		<table>
		<tr>
		<td style="width: 140px; font-size: 12pt;"><b>더 알아 보기</b></td>
		<td style="width: 140px; font-size: 30pt; text-align: right;">&#10158;</td>
		</tr>
		</table>
		</div>
		</div>		
