...
<tr style="width: 978px; height: 48px; line-height: 48px; margin-top: 45px;">
<td style="font-size: 32px;">1:1 문의내용
</tr>

<tr><td style="text-align: right;">
<input type="button" value="목록보기"
style="overflow:hidden; cursor: pointer; width: 104px; height: 40px; background-color: #fff;
border: 1px solid #d3d3d3; font-size: 120x; font-weight: 700;"
onclick="javascript:location.href='<%=cp%>/meatShop/qnaList1.do?pageNum=${pageNum }'">
</td></tr>

<tr><td height="20px;"></td></tr>
<tr style="width: 1100px; height: 48px; line-height: 48px; margin-top: 45px; font-size: 15px;
font-weight: 700; background-color: #f7f7f7; border: 1px solid #e1dedf;">
<td style="width: 130px; text-align: center; float: left;">
제목
</td>
<td style="width: 640px; border-left: 1px solid #e1dedf; border-right: 1px solid #e1dedf; text-align: center; float: left;">
내용
</td>
<td style="width: 230px; text-align: center; float: left;">
파일
</td>
...
<td style="width: 130px; height:200; text-align: center; float: left;">
${dto.qnaTitle }
</td>
<td style="width: 640px; border-left: 1px solid #e1dedf; border-right: 1px solid #e1dedf; height:200; text-align: center; float: left;">
${content }
</td>
<td style="width: 230px; height:200; text-align: center; float: left; color: rgb(203, 203, 203); ">
<a href="<%=cp %>/meatShop/download.do?qnaNum=${qnaNum }"><font style="font-size: 13px;">
...
<tr><td colspan="2" style="border-bottom: 1px solid #e1dedf;"></td></tr>

<tr><td height="70px;"></td></tr>

<tr style="width: 1100px; height: 48px; line-height: 48px; margin-top: 45px; font-size: 15px;
font-weight: 700; background-color: #f7f7f7; border: 1px solid #e1dedf;">
<td colspan="3" style="width: 1000px; text-align: center; float: left;">
답 변
</td>

</tr>

<tr><td colspan="3" height="60px;"></td></tr>

<tr>
<td colspan="3" style="width: 640px; height:500; text-align: center;">
<font style="font-size: 15px; font-weight: 700; color: #e1dedf;">최대한 빠르게 답변드리겠습니다. 감사합니다.</font>
</td>
<tr>
