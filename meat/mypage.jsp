...
<input style="cursor:pointer; float: rigth; height: 45px; padding: 10px; margin-right:5px; background-color: #000; color: #fff; font-size: 14px; font-weight: 700; margin-bottom: 10px;" type="button" value="내질문보기" 
onclick="javascript:location.href='<%=cp%>/meatShop/qnaList1.do'">
</td>
...
<td style="float:left; width: 19.75%; font-size: 24px; font-weight: 400; line-height: 24px; color: #000; margin-top: 10px; ">
적립금<br/>
<font color="#cbcbcb" size="3" >[${sessionScope.customInfo.userPoint }원]
</font>
</td>
...
<td style="float:left; width: 19.75%; font-size: 24px; font-weight: 400; line-height: 24px; color: #000; margin-top: 10px;">
구매<br/>
<font color="#cbcbcb" size="3" >[${sessionScope.customInfo.countBuy }건]</font>
</td>
...
font-weight: 700; border: none; display: block; margin-left: auto; margin-right: auto;" value="쇼핑하러가기          →"
onclick="javascript:location.href='<%=cp%>/meatShop/list.do'"/></td>
</tr>
