...
function sendIt1() {
	...
	f.action = "<%=cp%>/meatShop/created.do";
	f.submit();
...
<tr><td style="font-size: 24px; font-weight: 700; margin-top: 60px; text-align: center; color: #212121">회원가입</td></tr>
<tr style="height: 20px;"><td></td></tr>
</table>

<table style="margin: auto; text-align: center;">
<tr style="height: 20px;"><td></td></tr>
<tr><td style="margin-top: 60px; font-size: 18px; font-weight: 700; width: 328px; margin-left: auto; margin-right: auto;">SNS 계정으로 간편하게 가입하기</td></tr>
...
<tr style="height: 20px;"><td></td></tr>
<tr><td style="margin-top: 60px; font-size: 18px; font-weight: 700; width: 328px; margin-left: auto; margin-right: auto;">이메일로 가입하기</td></tr>
</table>
...
<table style="margin: auto; text-align: center;">
<tr>
<td><input style="width: 328px; height: 48px; border: 1px solid #e92d44; background-color: #fff; color: #e92d44; 
font-size: 16px; margin-top: 8px; border-radius: 4px; text-align: center;" type="button"  value="정육각 회원가입 하기" onclick="sendIt1();"/></td>
</tr>
