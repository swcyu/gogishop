...
function sendIt2() {
	...
	var f = document.myForm5;
	

	
	
	f.action = "<%=cp%>/meatShop/idCheck.do";
	f.submit();
	...
	f.action = "<%=cp%>/meatShop/mailCheck.do";
	...
	function sendIt3() {
		...
		f.action = "<%=cp%>/meatShop/created_real.do";
...
<script type="text/javascript">
	...
	function login() {
		...
		f.action = "<%=cp%>/meatShop/login_ok.do";
		f.submit();
	}
...
<script type="text/javascript">
	...
	function sendIt() {
		...
		cvalue = f.service.checked;
		cvalue1 = f.pinfo.checked;
		
		if(cvalue!=true){	
			alert("정육각 서비스 약관 동의 해주세요.")
			f.service.focus();
			return;
		}
		
		if(cvalue1!=true){	
			alert("개인정보 이용 방침 동의 해주세요.")
			f.pinfo.focus();
			return;
		}
		
		f.action = "<%=cp%>/meatShop/created_ok.do";
		f.submit();
...
<tr><td style="font-size: 32px; font-weight: 700; margin-top: 100px; text-align: center; color: #212121">회원가입</td></tr>
<tr style="height: 30px;"><td></td></tr>
<tr><td><img alt="" src="../meat//image/write.png"></td></tr>
...
<form action="" method="post" name="myForm5">
<table style="margin: auto;text-align: center;">
<tr style="height: 7px;"><td></td></tr>
<tr>
<td style="float:left; text-align: center; font-size: 15px; line-height: 24px;">가입정보 입력</td>
</tr>

<tr style="height: 15px;"><td></td></tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">아이디</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 350px; height: 40px; padding-left: 14px;" type="text" name="userId" value="${userId}" />
<input type="button" value="중복 확인" onclick="sendIt2();" style="background-color: #f7f7f7; border: 1px solid #e1dedf; width: 95px; height: 46px; font-weight 1000px; font-size: 13px;">
</td>
</tr>
...
<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">비밀번호</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="password" name="userPwd" value="${userPwd}"/>
</td>
</tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">비밀번호 확인</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="password" name="pwv" value="${userPwd}"/>
</td>
</tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">이름</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="text" name="userName" value="${userName}"/>
</td>
</tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">생일 [YYYY-MM-DD]</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="text" name="userBirth" value="${userBirth}"/>
</td>
</tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">전화</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="text" name="userPhone" value="${userPhone}" />
</td>
</tr>

<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">이메일인증</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 350px; height: 40px; padding-left: 14px;" type="text" name="emailCheck" value="${emailCheck }" />
<input type="button" value="인증번호 받기" onclick="sendIt1();" style="background-color: #f7f7f7; border: 1px solid #e1dedf; width: 95px; height: 46px; font-weight 1000px; font-size: 13px;">
</td>
</tr>
...
<tr>
<td style="float: left; text-align:left; width: 179px; border-right: 1px solid #e1dedf; background-color: #f7f7f7; font-size: 13px; line-height: 68px; padding-left: 30px;">인증번호</td>
<td style="width: 500px; height: 46px; border: 1px solid #e1dedf; padding-left: 14px; font-size: 14px; margin-top: 8px;">
<input style="border: 1px solid #e1dedf; width: 450px; height: 40px; padding-left: 14px;" type="text" name="checkNum" value="${checkNum }" />
</td>
</tr>
...
<tr style="margin: 6px;">
<td>
<input style="width: 100%; height: 60px; border: none; background-color: #888; color: #fff; 
font-size: 16px; text-align: center;" type="button"  value="이전으로" 
onclick="javascript:location.href='<%=cp%>/meatShop/created.do';"/>

</td>
<td>
<input style="width: 100%; height: 60px; border: none; background-color: #000; color: #fff; 
font-size: 16px; text-align: center;" type="button"  value="가입하기" onclick="sendIt3();"/>
</td>
</tr>
