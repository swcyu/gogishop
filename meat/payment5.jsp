...
<div style="margin-top: 100px; width: 1180px; height:1000px; margin-left: auto; margin-right: auto;">
	<div style="width: 1180px; height: 612px;" align="center">
		<div style="padding-top: 74px; font-size: 48px; text-align: center; font-weight: bold;">주문 완료</div>
		<div style="margin-top: 53px; font-size: 24px; text-align: center;">
			주문이 정상적으로 완료되었습니다.<br>상품 생산이 시작되면 또 연락드리겠습니다.
		</div>
		<div>
		
		<div style="margin-top: 50px; font-size: 21px; font-weight: bold; text-align: center;" align="center">주문내역</div>
			<div style="width: 800px; margin-top: 30px; "align="center">
				<div style="font-size:17px; width: 100%; height: 58px; background-color: #f7f7f7;border: 1px solid #bbbbbb; text-align: center; font-weight: 800; padding-top: 15px;">
					예금주: 정육각 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 기업은행: 02-1800-0658-1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 총 결제금액: ${finalPrice }
				</div>
				<div align="left" style=" width:800px; border: 1px solid #bbbbbb;">
				<c:forEach var="dto" items="${lists }">
					<div style="margin-left: 25px; width: 750px; margin-top: 42px; border-bottom: 1px solid #e1dedf; height: 25px; margin-bottom: 20px;">
				...
				<div style="font-size:14px; width: 800px; height: 33px;border:1px solid #723229; background-color: #ffdbdb;padding-left:10px; margin-top: 5px; color:#723229; padding-top: 3px ">
					입금자와 주문자가 다른경우, 반드시 고객센터(1800-0658)로 연락 부탁드립니다.
				</div>
				
				</div>
				
			</div>
			<div style="width: 380px; margin-top: 64px; margin-bottom: 120px;">
			<button type="button" name="forward" onclick="javascript:location.href='<%=cp %>/meatShop/mypage.do';" style="width: 100%; height: 60px;cursor:pointer; float: left; font-size: 16px;font-weight: 700; color: #fff; background: black; border: 0;">주문 확인하기</button>
			</div>
